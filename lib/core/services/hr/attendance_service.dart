...
class AttendanceService {
  ...
  Future<AttendanceRecord> clockIn({
    ...
    if (existing != null) {
      throw const BusinessException(message: 'تم تسجيل حضور هذا الموظف بالفعل اليوم');
    }
  ...
  Future<AttendanceRecord> clockOut({
    ...
    if (record == null) {
      throw const BusinessException(message: 'لم يتم تسجيل حضور هذا الموظف اليوم');
    }

    if (record.clockOut != null) {
      throw const BusinessException(message: 'تم تسجيل انصراف هذا الموظف بالفعل');
    }
