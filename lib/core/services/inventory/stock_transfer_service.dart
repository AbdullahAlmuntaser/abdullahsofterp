...
class StockTransferService {
  ...
  Future<void> processTransfer({
    ...
    if (fromWarehouseId == toWarehouseId) {
      throw const BusinessException(message: 'Source and destination warehouses must be different.');
    }
      ...
      for (var item in items) {
        ...
        if (sourceAvailable < item.quantity) {
          throw BusinessException(
            message: 'Insufficient stock in batch ${sourceBatch.batchNumber} for product ${item.productId}. '
