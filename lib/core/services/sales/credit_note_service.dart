...
class CreditNoteService {
  ...
  Future<CreditNote> createCreditNote({
    ...
    if (sale == null) throw const BusinessException(message: 'فاتورة المبيعات غير موجودة');
  ...
  Future<void> postCreditNote(String creditNoteId, {String? userId}) async {
    ...
    if (creditNote == null) throw const BusinessException(message: 'سند الائتمان غير موجود');
    if (creditNote.status == 'POSTED') throw const BusinessException(message: 'سند الائتمان مرحّل بالفعل');
