...
final GoRouter appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
        ...
        builder: (context, state) =>
            SalesInvoicePage(saleId: state.pathParameters['id'])),
    GoRoute(
        path: '/sales/returns',
    ...
    GoRoute(
        ...
        builder: (context, state) =>
            AddPurchasePage(purchaseId: state.pathParameters['id'])),
    GoRoute(
    ...
    GoRoute(
        ...
        builder: (context, state) => ManualVoucherPage(
            isReceipt: state.uri.queryParameters['receipt'] != 'false')),
    GoRoute(
    ...
    GoRoute(
        ...
        builder: (context, state) => const CashFlowForecastPage()),
    GoRoute(
        path: '/reports/audit',
